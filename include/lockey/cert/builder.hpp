...
class CertificateBuilder {
  public:
    ...
    CertificateBuilder &set_basic_constraints(bool is_ca, std::optional<uint32_t> path_length, bool critical = true);
    ...
    CertificateResult<Certificate> build(const crypto::Lockey::KeyPair &issuer_key,
  ...
  private:
    ...
    RawExtension build_basic_constraints_extension(bool is_ca, std::optional<uint32_t> path_length, bool critical) const;
    ...
    AlgorithmIdentifier signature_algorithm_{SignatureAlgorithmId::Ed25519, hash::Algorithm::SHA256, CurveId::Ed25519};
